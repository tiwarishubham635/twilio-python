...
class ClientCredentialProvider(CredentialProvider):
    def __init__(
        ...
        client_id: str, 
        client_secret: str, 
        token_manager: Optional["ClientTokenManager"] = None  # type: ignore
    ) -> None:
        ...
        self.auth_strategy: Optional[TokenAuthStrategy] = None

    def to_auth_strategy(self) -> TokenAuthStrategy:
